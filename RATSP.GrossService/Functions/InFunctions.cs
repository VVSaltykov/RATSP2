...
public static class InFunctions
{
        ...
        List<Fraction> fractions, DateOnly selectedDate)
    {
        ...
        ExcelHelper.SetCellValue(sheet, 10, 4,
            ...
            "Calibri", 9, (12, 25.4),
            mergeRegion: (10, 10, 4, 5), applyBorders: true, isBold: true,
            wrapText: true, textCenter: true);
        
        ExcelHelper.SetCellValue(sheet, 10, 9,
            "К начислению в РАТСП",
            "Calibri", 9, (15.73, 25.4),
            mergeRegion: (10, 10, 9, 13), applyBorders: true, isBold: true,
            wrapText: true, textCenter: true);
        
        ExcelHelper.SetCellValue(sheet, 10, 14,
            "К оплате в РАТСП",
            "Calibri", 9, (11.4, 25.4),
            mergeRegion: (10, 10, 14, 17), applyBorders: true, isBold: true, 
            wrapText: true, textCenter: true);
        
        ExcelHelper.SetCellValue(sheet, 10, 18,
            "Справочно",
            "Calibri", 9, (16.27, 25.4), applyBorders: true, isBold: true,
            wrapText: true, textCenter: true);
        ...
        ExcelHelper.SetCellValue(sheet, 11, 12,
            ...
            "Calibri", 9, (10.4, 93), applyBorders: true, isBold: true, 
            wrapText: true, textCenter: true);
        ...
        ExcelHelper.SetCellValue(sheet, 11, 16,
            ...
            "Calibri", 9, (12.87, 93), applyBorders: true, isBold: true,
            wrapText: true, textCenter: true);
        ...
        Company company, List<Fraction> fractions, DateOnly selectedDate)
    {
        ...
        ExcelHelper.SetCellValue(sheet, rowCount, 0,
            ...
            "Calibri", 9, (5.27, 14.3),
            mergeRegion: (rowCount, rowCount, 0, 19), applyBorders: true, isBold: true, textCenter: true);
        ...
        foreach (var excelValues in excelValuesList)
        {
                ...
                DateOnly.Parse(excelValues.StartDate) <= companyFraction.End && excelValues.Insurer != company.Name)
            {
                ...
                ExcelHelper.SetCellValue(sheet, rowCount, 1,
                    $"{excelValues.Insurer}",
                    "Calibri", 11, (25.27, 57), applyBorders: true, wrapText: true);
                ...
                ExcelHelper.SetCellValue(sheet, rowCount, 17,
                    ...
                    "Calibri", 11, (16.27, 57), applyBorders: true, wrapText: true);
